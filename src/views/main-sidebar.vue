      ...
      <el-menu
        ...
        <el-menu-item index="home" @click="$router.push({ name: 'home' })">
         ...
         <el-submenu index="setup">
          <template slot="title">
            <icon-svg name="setup" class="site-sidebar__menu-icon" style="font-size: 31px;margin: 0 0 0 -9px;"></icon-svg>
            <span>体系管理</span>
          </template>
        ...
        <el-submenu index="business">
          <template slot="title">
            <icon-svg name="business" class="site-sidebar__menu-icon" style="font-size: 31px;margin: 0 0 0 -9px;"></icon-svg>
            <span>业务管理</span>
          </template>
